...
export function CookieBanner({ onAccept, onDenied, onLoad, onEnter, onMinimize, onMaximize, acknowledge }) {
  useEffect(() => {}, []);
      ...
      <div id="terminal" className="cookie-banner">
        ...
        <div id="console-results" className="cookie-banner-body">
          <div id="console-header">
            The following command line interface is created to make possible to change
            ...
            <br />
            | In order to see the available commands enter the &nbsp;  |
            | command `help` &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
const onCommandEnter = (evt, dispatch) => {
  if (evt.key === 'Enter' && evt.target.value.length > 0) {
    ...
    switch (value) {
      ...
      default:
        result = [
          "Command " + evt.target.value + " not found"
        ];
        break;
    }
